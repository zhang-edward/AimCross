...
public class GameUI : MonoBehaviour {
	...
	public Text puPointNormal;
	public Text puPointArea;
	public Text puInvert;
	public Text puCrossClear;

	public Text gameMenuScore;
	public Text gameMenuPoints;
	...
	void Update()
	{
		// change scoreTextIncrementer to change to score
		...
		puPointNormal.text = "" + ScoreManager.instance.PU_PointNormal;
		puPointArea.text = "" + ScoreManager.instance.PU_PointArea;
		puInvert.text = "" + ScoreManager.instance.PU_Invert;
		puCrossClear.text = "" + ScoreManager.instance.PU_CrossClear;
	...
	public void GameMenu()
	{
		...
		gameMenuPoints.text = "-" + ScoreManager.instance.Points + "-";
	}
